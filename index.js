...
function drawBoids() {
  for (const boid of boids) {
    drawCircle(boid.x, boid.y, boidDrawSize, "#ff00ff");
    if (debug) {
      drawCircle(boid.x, boid.y, boidProtectedRange, undefined, "#ff0000");
      drawCircle(boid.x, boid.y, boidVisualRange, undefined, "#ff5500");
